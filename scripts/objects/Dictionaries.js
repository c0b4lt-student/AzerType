const wordDictionary = [
  "apple", "banana", "orange", "grape", "pineapple", "lemon", "strawberry", "watermelon", "kiwi", "peach",
  "cat", "dog", "bird", "fish", "elephant", "lion", "tiger", "giraffe", "monkey", "zebra",
  "car", "bike", "train", "bus", "airplane", "boat", "subway", "truck", "motorcycle", "scooter",
  "computer", "phone", "tablet", "keyboard", "mouse", "printer", "monitor", "laptop", "charger", "speaker",
  "table", "chair", "sofa", "bed", "cabinet", "lamp", "mirror", "clock", "shelves", "desk",
  "house", "apartment", "garden", "bedroom", "bathroom", "kitchen", "living room", "dining room", "garage", "attic",
  "happy", "sad", "angry", "excited", "bored", "tired", "surprised", "scared", "proud", "shy",
  "book", "pen", "pencil", "notebook", "dictionary", "newspaper", "magazine", "map", "calendar", "envelope",
  "sun", "moon", "star", "cloud", "rain", "wind", "snow", "thunder", "lightning", "rainbow",
  "red", "blue", "green", "yellow", "orange", "purple", "pink", "black", "white", "gray",
  "music", "movie", "painting", "photograph", "poem", "novel", "sculpture", "dance", "theater", "opera",
  "beach", "mountain", "forest", "lake", "river", "desert", "island", "cave", "volcano", "waterfall",
  "friend", "family", "teacher", "student", "doctor", "engineer", "artist", "writer", "musician", "athlete",
  "love", "hate", "peace", "war", "freedom", "justice", "equality", "happiness", "sadness", "fear", "about", "above", "accept", "accident", "account", "achieve", "across", "action", "actor", "actually",
  "add", "address", "admire", "adventure", "after", "again", "against", "age", "ago", "agree",
  "air", "all", "almost", "alone", "along", "already", "also", "always", "amazing", "amount",
  "angry", "animal", "announce", "another", "answer", "anxiety", "any", "apart", "appear", "apply",
  "area", "arm", "around", "arrive", "art", "ask", "atmosphere", "attach", "attack", "attempt",
  "attention", "attitude", "attract", "audience", "author", "automatic", "available", "avoid", "awake", "away",
  "awesome", "awful", "baby", "back", "bad", "bag", "ball", "bank", "base", "basic",
  "basket", "battle", "beach", "bear", "beat", "beautiful", "bed", "beer", "before", "begin",
  "behind", "believe", "bell", "below", "best", "better", "between", "beyond", "big", "bird",
  "birth", "bit", "black", "blame", "bleed", "block", "blood", "blow", "blue", "board",
  "boat", "body", "bone", "book", "border", "born", "borrow", "both", "bother", "bottle",
  "bottom", "bound", "box", "boy", "brain", "branch", "brave", "bread", "break", "breath", "bride", "bridge", "bright", "bring", "brother", "brown", "brush", "build", "burn", "burst",
  "bus", "business", "busy", "but", "buy", "by", "cake", "call", "camera", "camp",
  "can", "candle", "capital", "captain", "capture", "car", "card", "care", "carry", "case",
  "catch", "cause", "ceiling", "celebrate", "cell", "center", "century", "certain", "chain", "chair",
  "challenge", "chance", "change", "channel", "chapter", "charge", "chase", "chat", "cheap", "cheese",
  "chest", "chicken", "chief", "child", "choice", "choose", "church", "circle", "city", "claim",
  "clap", "class", "clean", "clear", "climb", "clock", "close", "cloth", "cloud", "club",
  "clue", "coach", "coast", "coat", "code", "coffee", "coin", "cold", "collect", "color",
  "come", "comfort", "common", "company", "compare", "compete", "complete", "complex", "computer", "concept",
  "concern", "concert", "condition", "confuse", "connect", "consider", "consume", "contact", "contain", "content",
  "continue", "control", "cook", "cool", "corner", "correct", "cost", "cotton", "couch", "count",
  "country", "couple", "courage", "course", "court", "cover", "cow", "crash", "crazy", "cream",
  "create", "credit", "crew", "crime", "cross", "crowd", "crush", "cry", "culture", "cup",
  "curious", "current", "curve", "cut", "cycle", "dad", "damage", "dance", "danger", "dare",  "dark", "data", "date", "daughter", "day", "dead", "deal", "dear", "death", "debate",
  "debt", "decade", "decay", "decent", "decide", "deck", "declare", "decorate", "decrease", "deer",
  "defeat", "defend", "define", "defy", "degree", "delay", "deliver", "demand", "democracy", "den",
  ...
  "disorder", "display", "distance", "distract", "dive", "divide", "divorce", "dizzy", "doctor", "document",
  "dog", "doll", "dolphin", "domain", "donate", "donkey", "donor", "door", "dose", "double",
  "doubt", "dozen", "draft", "dragon", "drama", "drastic", "draw", "dream", "dress", "drift",
  ...
  "elevator", "elite", "else", "embark", "embody", "embrace", "emerge", "emotion", "employ", "empty", "enable", "enact", "end", "endless", "endorse", "enemy", "energy", "enforce", "engage", "engine",
  "enhance", "enjoy", "enlist", "enough", "enrich", "enroll", "ensure", "enter", "entire", "entry",
  "envelope", "envy", "equal", "equip", "era", "erase", "erode", "erosion", "error", "erupt",
  ...
  "exhibit", "exile", "exist", "exit", "exotic", "expand", "expect", "expire", "explain", "explode",
  "explore", "export", "expose", "express", "extend", "extra", "eye", "eyebrow", "fabric", "face",
  "faculty", "fade", "faint", "faith", "fall", "false", "fame", "family", "famous", "fan",
  "fancy", "fantasy", "farm", "fashion", "fast", "fat", "father", "fatigue", "fault", "favor",
  "fear", "feast", "feather", "feature", "february", "federal", "fee", "feed", "feel", "female",
  "fence", "festival", "fetch", "fever", "few", "fiber", "fiction", "field", "figure", "file",
  "fill", "film", "filter", "final", "find", "fine", "finger", "finish", "fire", "firm",
  "first", "fiscal", "fish", "fit", "fitness", "fix", "flag", "flame", "flash", "flat", "flavor", "flee", "flight", "flip", "float", "flock", "floor", "flower", "fluid", "flush",
  ...
  "gown", "grab", "grace", "grain", "grant", "grape", "grass", "gravity", "great", "green", "grid", "grief", "grit", "grocery", "group", "grow", "grunt", "guard", "guess", "guide",
  ...
  "jewel", "job", "join", "joke", "journey", "joy", "judge", "juice", "jump", "jungle", "junior", "junk", "just", "kangaroo", "keen", "keep", "ketchup", "key", "kick", "kid",
  ...
  "maximum", "maze", "meadow", "mean", "measure", "meat", "mechanic", "medal", "media", "melody", "melon", "melt", "member", "memory", "mention", "menu", "mercy", "merge", "merit", "merry",
  ...
  "orchard", "order", "ordinary", "organ", "orient", "original", "orphan", "ostrich", "other", "outdoor", "outer", "output", "outside", "oval", "oven", "over", "own", "owner", "oxygen", "oyster",
  ...
  "spatial", "spawn", "speak", "special", "speed", "spell", "spend", "sphere", "spice", "spider", "spike", "spin", "spirit", "split", "spoil", "sponsor", "spoon", "sport",
  ...
  "weapon", "wear", "weasel", "weather", "web", "wedding", "weekend", "weird", "welcome", "west", "wet", "whale", "what", "wheat", "wheel",
...
/**
 * Shuffle a word list with Fisher-Yates algorithm.
 * @param {Array.<string>} dictionary
 */
function shuffleAndFilterDictionary(dictionary) {
